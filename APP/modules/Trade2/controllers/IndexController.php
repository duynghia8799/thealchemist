...
class Trade2_IndexController extends Zend_Controller_Action {
...
//        }
    ...
    public function saveAction() {
        ...
        if (strtotime($detail['date']) < strtotime(date("Y-m-d") . '-2 day')) {
            die(json_encode([
                'error' => true,
                'notice' => 'It is too long from the date of model, the analysis is not reliable any more'
            ]));
        }
