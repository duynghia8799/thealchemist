    ...
    protected function _run()
    {
		...
		*/
		public function translate( $word ){
			...
			if( is_array($word) ){
				foreach( $word as $language => $value ){
			...
			$dir = $this->module != "Admin"
				?	APPLICATION_PATH ."/languages/".strtolower($this->language).".ini"
				: APPLICATION_PATH ."/languages/".strtolower($this->module).".ini";
			if( !isset( $this->langData ) ){
				$this->langData = @parse_ini_file( $dir );
			}
			return isset( $this->langData[$word] ) ?	str_replace(array("\\'","\\'"),array('"','"'),$this->langData[$word]) : $word;
		}
		/*
			Escape
		*/
